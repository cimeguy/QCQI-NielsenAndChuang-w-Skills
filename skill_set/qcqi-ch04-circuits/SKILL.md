...
| 小节 | 标题 | 关键概念 |
|---|---|---|
| [4.1](chapters/sec4.1-single-qubit-gates.md) | 单比特门 $U(2)$ | $R_x/R_y/R_z/R_n$、H、S、T、门=旋转、z-y-z 分解、无通用非门 |
...
| [4.4](chapters/sec4.4-universal-gates.md) | 通用量子门 | 三步通用性证明、$\{H,T,\mathrm{CNOT}\}$、复杂度 |
